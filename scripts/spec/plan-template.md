...
<!-- PATCHED(repository-standards): ADR-002 capability paths - [###-feature-name]/[###-feature] placeholders replaced with slug-only [feature-name]/[feature]; feature dirs carry no numeric prefix -->
**Branch**: `[feature-name]` | **Date**: [DATE] | **Spec**: [link]

**Input**: Feature specification from `/specs/[feature-name]/spec.md`

**Note**: This template is filled in by the `/spec-plan` command; its definition describes the execution workflow.

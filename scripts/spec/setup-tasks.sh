...
if [[ -z "$TASKS_TEMPLATE" ]] || [[ ! -f "$TASKS_TEMPLATE" ]]; then
    ...
    echo "Template 'tasks-template' was not found in any supported location (overrides, presets, extensions, or shared core). Add an override at scripts/spec/overrides/tasks-template.md, or restore the core scripts/spec/tasks-template.md template." >&2
    exit 1
fi
